...
OUTPUT_PREFIX = "weekly_v8_rs5_52w_ath_sma20_no_cup_breakout"
...
# 20 SMA must be above 50 SMA, but not more than 20% above it.
MAX_SMA20_ABOVE_SMA50_PCT = 20.0
...
def print_settings() -> None:
    print("=" * 80)
    print("WEEKLY V8 RS5 52W/ATH + SMA20<20 NO-CUP BREAKOUT BACKTEST")
    print("=" * 80)
    print("Entry setup:")
    ...
    print("- SMA structure: 20 SMA > 50 SMA, but 20 SMA must be less than 20% above 50 SMA")
    ...
    print("- Debug output includes Prior 52W High, Prior ATH High, and Breakout Level")
    print("Exit:")
